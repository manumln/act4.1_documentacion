...
public class Empleado {
	private int emp_no; // Codigo identificador del empleado
	private String nombre; // Nombre del empleado
	private String apellido; // Apellido del empleado
	private String pobla; // Ciudad del empleado
	...
	* @param emp_no  Codigo identificador del empleado.
	...
	/**
	 * Método que nos sube el salario.
	 *
	 * @param subida Parametro de la subida del sueldo.
	 */
